...
AtomVecRHEO::AtomVecRHEO(LAMMPS *lmp) : AtomVec(lmp)
{
  ...
  fields_grow = {"rheo_status", "rho", "drho", "pressure", "viscosity", "fsph", "fbpm"};
  fields_copy = {"rheo_status", "rho", "drho", "pressure", "viscosity", "fsph", "fbpm"};
  fields_comm = {"rheo_status", "rho"};
  fields_comm_vel = {"rheo_status", "rho"};
  fields_reverse = {"drho", "fsph", "fbpm"};
  ...
  fields_create = {"rheo_status", "rho", "drho", "pressure", "viscosity", "fsph", "fbpm"};
...
void AtomVecRHEO::force_clear(int n, size_t nbytes)
{
  ...
  memset(&fsph[0][0],0,3*nbytes); // jsm
  memset(&fbpm[0][0],0,3*nbytes); // jsm
}
